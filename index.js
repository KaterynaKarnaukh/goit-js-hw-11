import{a as f,S as g,i as a}from"./assets/vendor-BcgDYiff.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const y="54229913-72a9171c24bd99d1654402387",h="https://pixabay.com/api/";async function b(s){const r={key:y,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0};return(await f.get(h,{params:r})).data}const u=document.querySelector(".gallery"),p=document.querySelector(".loader");let L=new g(".gallery a",{captionsData:"alt",captionDelay:250});function S(s){const r=s.map(({webformatURL:o,largeImageURL:i,tags:e,likes:t,views:n,comments:m,downloads:d})=>`
